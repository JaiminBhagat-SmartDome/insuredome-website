...
const PRODUCTS: Product[] = [
  { key: 'motor', icon: 'two_wheeler', accentColor: 'text-green-400' },
  { key: 'health', icon: 'favorite', accentColor: 'text-red-400' },
  { key: 'term', icon: 'security', accentColor: 'text-blue-400' },
];
          ...
          >
            ...
            <div className="p-8 pb-4">
              <div className="flex justify-center mb-6">
                <span className={`material-symbols-outlined text-6xl ${accentColor} group-hover:scale-110 transition-transform`}>
                  {icon}
                </span>
              </div>
            ...
            <div className="px-8 py-4 border-t border-white/10 flex-grow">
              ...
              <ul className="space-y-2">
                {t(`products.${key}.benefits`, { returnObjects: true }).map((benefit: string, idx: number) => (
